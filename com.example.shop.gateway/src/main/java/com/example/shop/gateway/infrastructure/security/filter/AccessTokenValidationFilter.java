...
import com.example.shop.gateway.infrastructure.resttemplate.auth.client.AuthRestTemplateClientV1;
...
public class AccessTokenValidationFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        return Mono.fromCallable(() -> authRestTemplateClientV1.checkAccessToken(accessToken))
